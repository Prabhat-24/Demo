...
contract Erc1155 is IERC1155, IERC1155Receiver, Erc1155Storage {
    ...
    modifier onlyOwner() {
        require(owner == msg.sender, "Erc1155: only owner");
        _;
    }
    ...
    function _mint(
        ...
        require(balanceOf(_to, _id) == 0, "Erc1155: token already exist");
        setTokenURI(_id);
    ...
    function increaseSupply(
        ...
        require(totalSupply[_id] != 0, "Erc1155: token not exist");
        require(balanceOf(_account, _id) != 0, "Erc1155: invalid account");
        totalSupply[_id] += _amount;
        _balances[_id][_account] += _amount;
        emit Changesupply(address(0), _account, _id, _amount);
    }
